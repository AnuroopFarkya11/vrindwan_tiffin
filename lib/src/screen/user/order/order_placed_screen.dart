  ...
  void _mapOrderStatusToStatus(OrderStatus orderStatus) {
    switch (orderStatus) {
      case OrderStatus.loading:
        StatusIndicator.updateStatus(Status.loading,message: "Hang tight! We’re placing your orderrrrr...");
        break;
      case OrderStatus.loaded:
        StatusIndicator.updateStatus(Status.success,message: "Order placed! You’re all set! 🎉");
        break;
      case OrderStatus.failed:
        StatusIndicator.updateStatus(Status.error,message: "Oops! Looks like there was an issue placing your order.");
        break;
      default:
        {
